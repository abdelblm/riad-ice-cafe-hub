      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in">
          ...
          <p className="text-lg text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
            Découvrez l'authenticité de la cuisine marocaine dans un cadre
            moderne et élégant
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-scale-in">
            ...
            <Button
              variant="ghost"
              className="font-semibold px-4 py-2 rounded-xl shadow bg-green-700 text-white hover:bg-green-800 hover:text-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
            >
              Commander en Ligne
            </Button>
          </div>
